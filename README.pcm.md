...
**Interaction atlas wey put effect first**

Na only Demo wey pass visual review with 80 score or more we dey publish; each one get real preview, small useful code, and implementation prompt.
...
[**See effects →**](https://giraffe-tree.github.io/awesome-web-effects/?lang=pcm) · [Language metadata / 语言资料](docs/LANGUAGES.md)
...
<h3 align="center">15 Verified GIFs / 151 Effects</h3>

<table>
<tr>
<td width="33%" align="center">
<a href="https://giraffe-tree.github.io/awesome-web-effects/?lang=pcm#connected-fragment-story-stage"><img src="demo/gifs/captured/connected-fragment-story-stage.gif" width="270" alt="Connected fragment story stage"></a>
<br>
...
<table>
<tr>
<td width="25%" align="center"><strong>151</strong><br><sub>Effects</sub></td>
<td width="25%" align="center"><strong>151</strong><br><sub>Verified GIFs</sub></td>
<td width="25%" align="center"><strong>149</strong><br><sub>Local Demo</sub></td>
<td width="25%" align="center"><strong>80/100</strong><br><sub>Curatorial admission score</sub></td>
</tr>
</table>

<table>
<tr>
<td width="33%"><strong>See di real Demo before you build am.</strong><br><sub>Every published entry don pass 100-point review for creativity, art direction, motion, readability, inspiration, and evidence.</sub></td>
<td width="33%"><strong>Start with code wey dey work.</strong><br><sub>Open any effect make you copy di smallest useful implementation for di recommended source.</sub></td>
<td width="33%"><strong>Give am to your coding agent.</strong><br><sub>One click go copy scoped prompt with accessibility, responsive design, cleanup, and reduced-motion requirements.</sub></td>
</tr>
</table>
...
<p align="center"><sub>Effect-first, multilingual, and built for implementation. Project names and previews still belong to their authors.</sub></p>
