...
component labels, three deterministic identity samples, and four deterministic
expression samples. It does not contain Google’s full 50.8 MB model, decoder
